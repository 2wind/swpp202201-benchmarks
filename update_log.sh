...
check() {
  ...
  cp sf-interpreter.log ${problem}/sf-interpreter.log
  cp sf-interpreter-cost.log ${problem}/sf-interpreter-cost.log
  cp sf-interpreter-inst.log ${problem}/sf-interpreter-inst.log
